...
class DeviceGroupsCategory extends StatelessWidget {
  final String categoryState;

  const DeviceGroupsCategory({super.key, required this.categoryState});
      ...
      child: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: TextFormField(
              controller: AppControllers.homeTabDeviceGroupsSearchController,
