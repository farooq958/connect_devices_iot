...
import 'package:veevo_connect/Controllers/Cubits/SwitchCubit/switch_cubit.dart';
      ...
      return BlocListener<EditDeviceCubit, EditDeviceState>(
        listener: (context, editState) {
          if (editState is EditDeviceSuccess) {
            Utils.showSnackBar(
                context: context,
                message: editDeviceController.message,
                status: "Success");
            context.read<AllDevicesCubit>().loadUserDevices("");
          }
          else if(editState is EditDeviceInternetError)
            {
              Utils.showSnackBar(
                  context: context,
        ...
        child: Container(
          ...
          child:
     BlocConsumer<SetDeviceFavouriteCubit, SetDeviceFavouriteState>(
            listener: (context, favouriteState) {
              if (favouriteState is SetDeviceFavouriteSuccess) {
                Utils.showSnackBar(
                    context: context,
                    message: setFavouriteDeviceController.message,
                    status: setFavouriteDeviceController.status);
              }
              ...
              return BlocConsumer<AllDevicesCubit, AllDevicesState>(
                ...
                builder: (context, allDevicesState) {
                  if (allDevicesState is AllDevicesLoaded) {
                    // List<Map<String,bool>> toAdd=List.generate(allUserDevices.userDevices.length, (index) => {allUserDevices.userDevices[index].name:false});
                    //
                    // context.read<SwitchCubit>().switchToggleState(toAdd);
                    return ListView(
                      shrinkWrap: true,
                      ...
                      children: [
                          ...
                          child: TextFormField(
                            onChanged: (value) {
                              ...
                              context
                                  ...
                                  .loadUserDevices(value);
                            },
                            controller:
                                AppControllers.homeTabDevicesSearchController,
                        ...
                        //list of devices
                        BlocConsumer<SwitchCubit, List<Map<String,bool>>>(
  listener: (context, state) {
    // TODO: implement listener
  },
  builder: (context, switchStateBuilder) {
    return Container(
                          height: 500.sp,
                          width: 1.sw,
                          color: AppColors.white,
                          child: allUserDevices.status == "error"
                              ? const Center(child: Text("No Device Found "))
                              : allUserDevices.userDevices.isEmpty
                                  ...
                                  : ListView.separated(
                                      ...
                                      itemCount:
                                          allUserDevices.userDevices.length,
                                                    ...
                                                    children: [
                                                      ...
                                                      Positioned(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          decoration:
                                                              BoxDecoration(
                                                            color: switchStateBuilder[index][allUserDevices.userDevices[index].name]==true?
                                                            AppColors.creamy:AppColors
                                                                .greyTenth,
                                                            borderRadius:
                                                                BorderRadius
                                                                    .circular(
                                                     ...
                                                     Positioned(
                                                        bottom:switchStateBuilder[index][allUserDevices.userDevices[index].name]==true?45:switchStateBuilder[index][allUserDevices.userDevices[index].name]==false?5:0,//45
                                                        left: 5,
                                                        right: 5,
                                                         ...
                                                         child: InkWell(
                                                           onTap: (){
                                                            //  print("heressssss");
                                                            // print( switchStateBuilder[index]["Fan"]);
                                                            //  print(switchStateBuilder);
                                                            //  print(toAdd);toAdd
                                                           print(allUserDevices.userDevices[index].name);
                                                           if( switchStateBuilder[index][allUserDevices.userDevices[index].name]==true){

                                                             switchStateBuilder[index][allUserDevices.userDevices[index].name]=false;
                                                          context.read<SwitchCubit>().switchToggleState(switchStateBuilder);

                                                           }
                                                           else
                                                             {
                                                               switchStateBuilder[index][allUserDevices.userDevices[index].name]=true;
                                                               context.read<SwitchCubit>().switchToggleState(switchStateBuilder);
                                                           ...
                                                           setState(() {
                                                            ...
                                                            // print("switch tap");
//                                                 if(switchStateBuilder[index].containsKey(allUserDevices.userDevices[index].name)==false){
//                                                   print(index);
//                                                   print("index${toAdd[index]}");
//                                                   toAdd[index]={allUserDevices.userDevices[index].name:true};
//                                                   print('object');
//                                                  //toAdd.insert(index,{allUserDevices.userDevices[index].name:true});
//
//                                                  context.read<SwitchCubit>().switchToggleState(toAdd);
//                                                 }
//      else if((switchStateBuilder[index].containsKey(allUserDevices.userDevices[index].name))==true
//                                                     && (switchStateBuilder[index].containsValue(false))==true)
//      {
//  //toAdd.add({allUserDevices.userDevices[index].name:true});
//         toAdd[index]={allUserDevices.userDevices[index].name:false};
...
//         context.read<SwitchCubit>().switchToggleState(switchStateBuilder);
//      }
//       else if((switchStateBuilder[index].containsKey(allUserDevices.userDevices[index].name))==true &&( switchStateBuilder[index].containsValue(true))==true)
//         {
//           print("true true condition");
//           //toAdd[index][allUserDevices.userDevices[index].name]=false;
//           toAdd[index]={allUserDevices.userDevices[index].name:false};
//           switchStateBuilder[index]={allUserDevices.userDevices[index].name:false};
//           //toAdd.insert(index,{allUserDevices.userDevices[index].name:false});
//           context.read<SwitchCubit>().switchToggleState(switchStateBuilder);
//
//         }
//       else
...
//menu Item Favourite click event
                                                      if (value ==
                                                          MenuItem.Favourite) {
                                                        print(
                                                            "favourite selct+${allUserDevices.userDevices[index].id}");
                                                        context
                                                            .read<
                                                                SetDeviceFavouriteCubit>()
                                                            .setDeviceFavouriteAdd(
                                                                allUserDevices
                                                                    .userDevices[
                                                                        index]
                                                                    .id);
...
//print(value.isEmpty);
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Expanded(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          controller:
                                                                              AppControllers.editDeviceLongController,
                                                                          style:
                                                                              GoogleFonts.poppins(
                                                                            fontSize:
                                                                                12.0.sp,
                                                                      ...
                                                                      Expanded(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          keyboardType:
                                                                              const TextInputType.numberWithOptions(decimal: true),
                                                                          controller:
                                                                              AppControllers.editDeviceLatController,
                                                                          style:
                                                                              GoogleFonts.poppins(
                                                                            fontSize:
                                                                                12.0.sp,
                                                          ...
                                                          actions: [
                                                            BlocBuilder<
                                                                ButtonEnableDisableCubit,
                                                                bool>(
                                                              builder: (context,
                                                                  buttonState) {
                                                                // print(buttonState);
                                                                return MaterialButton(
                                                                  color: buttonState == false
                                                                      ? AppColors
                                                                          .greyThree
                                                                      : AppColors
                                                                          .themeColorTwo,
                    ...
                    return const Text(
                      "Unknown Error , Connection is down or refused to connect ",
                      style:
                          TextStyle(fontWeight: FontWeight.bold, fontSize: 40),
                    );
                  } else {
